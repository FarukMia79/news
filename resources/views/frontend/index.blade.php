...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <div class="main-section" style="overflow: hidden;">
        ...
        <!--=========ThemesBazar==============
                                                                                        Section One Start
                                                                            ============ThemesBazar==============-->
        <section class="section_one secOne_color">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="secOne_wrpp"><!--  Wrpp start-->
                            <div class="secOne_image">
                                @foreach ($first_sec_thum as $First_sec_thum)
                                    @if (session()->get('language') == 'english')
                                        <img class="lazyload" src="{{asset($First_sec_thum->image)}}"
                                            alt="{{$First_sec_thum->title_en}}" title="{{$First_sec_thum->title_en}}">

                                        <h5 class="secOne_title ">
                                            <a href="{{Route('view-post', $First_sec_thum->id)}}"> {{$First_sec_thum->title_en}}</a><!--136.html-->
                                        </h5>
                                    @else
                                        <img class="lazyload" src="{{asset($First_sec_thum->image)}}"
                                            alt="{{$First_sec_thum->title_bn}}" title="{{$First_sec_thum->title_bn}}">

                                        <h5 class="secOne_title">
                                            <a href="{{Route('view-post', $First_sec_thum->id)}}"> {{$First_sec_thum->title_bn}}</a>
                                        </h5>
                                    @endif
                                @endforeach
                            </div>
                            ...
                            @foreach ($first_section as $First_section)
                                @if (session()->get('language') == 'english')
                                    <div class="themesBazar-2 themesBazar-m2">
                                        <div class="secOne_wrpp"><!--  Wrpp start-->
                                            <div class="secOne_image2">

                                                <img class="lazyload" src="{{asset($First_section->image)}}"
                                                    data-src="{{asset($First_section->image)}}" alt="{{$First_section->title_en}}"
                                                    title="{{$First_section->title_en}}">

                                                <h5 class="secOne_title2">
                                                    <a href="{{Route('view-post', $First_section->id)}}"> {{$First_section->title_en}} </a>
                                                </h5>
                                            </div>
                                        </div><!-- End wrpp-->
                                    </div>
                                    ...
                                    <div class="themesBazar-2 themesBazar-m2">
                                        <div class="secOne_wrpp"><!--  Wrpp start-->
                                            <div class="secOne_image2">
                                                ...
                                                <img class="lazyload" src="{{asset($First_section->image)}}"
                                                    data-src="{{asset($First_section->image)}}" alt="{{$First_section->title_bn}}"
                                                    title="{{$First_section->title_bn}}">

                                                <h5 class="secOne_title2">
                                                    <a href="{{Route('view-post', $First_section->id)}}"> {{$First_section->title_bn}} </a>
                                                </h5>
                                            </div>
                                        </div><!-- End wrpp-->
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <div class="row">
                            @foreach ($first_section_2 as $First_section_2)
                                @if (session()->get('language') == 'english')
                                    <div class="themesBazar-3 themesBazar-m2">
                                        <div class="secTwo_wrpp"><!-- secTwo Wrpp start-->
                                            <div class="secTwo_image">
                                                <img class="lazyload" src="{{asset($First_section_2->image)}}"
                                                    data-src="{{asset($First_section_2->image)}}"
                                                    alt="{{$First_section_2->title_bn}}" title="{{$First_section_2->title_en}}">



                                            </div>
                                            <h5 class="secTwo_title">
                                                <a href="{{Route('view-post', $First_section_2->id)}}"> {{$First_section_2->title_en}} </a>
                                            </h5>
                                            ...
                                            <h6 class="cat-meta">
                                                <a href="#"> <i class="lar la-newspaper"></i> ২ বছর আগে
                                                </a>
                                            </h6>
                                    ...
                                    <div class="themesBazar-3 themesBazar-m2">
                                        <div class="secTwo_wrpp"><!-- secTwo Wrpp start-->
                                            <div class="secTwo_image">
                                                <img class="lazyload" src="{{asset($First_section_2->image)}}"
                                                    data-src="{{asset($First_section_2->image)}}"
                                                    alt="{{$First_section_2->title_en}}" title="{{$First_section_2->title_bn}}">



                                            </div>
                                            <h5 class="secTwo_title">
                                                <a href="{{Route('view-post', $First_section_2->id)}}"> {{$First_section_2->title_bn}} </a>
                                            </h5>
                            ...
                            <ul class="nav nav-pills" id="recentPopular-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link active" id="recent-tab" data-bs-toggle="pill"
                                        data-bs-target="#recent" role="tab" aria-controls="recent" aria-selected="false">
                                        সর্বশেষ সংবাদ </div>
                                </li>
                                ...
                                <div class="news-tavs">
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bd9b6a47465.jpg"
                                                alt="৫ ধরনের ছুটির সুবিধাসহ আর্থিক প্রতিষ্ঠানে চাকরির সুযোগ"
                                                title="৫ ধরনের ছুটির সুবিধাসহ আর্থিক প্রতিষ্ঠানে চাকরির সুযোগ">



                                            <h4 class="tab_hadding"><a href="137.html"> ৫ ধরনের ছুটির সুবিধাসহ আর্থিক
                                                    প্রতিষ্ঠানে চাকরির সুযোগ </a></h4>
                                            <div class="conut">
                                                ১
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbcb42b1065.jpg"
                                                alt="এক্সিকিউটিভ মোটরস বাংলাদেশে আনলো ‘বিএমডব্লিউ এক্স সেভেন’"
                                                title="এক্সিকিউটিভ মোটরস বাংলাদেশে আনলো ‘বিএমডব্লিউ এক্স সেভেন’">



                                            <h4 class="tab_hadding"><a href="136.html"> এক্সিকিউটিভ মোটরস বাংলাদেশে আনলো
                                                    ‘বিএমডব্লিউ এক্স সেভেন’ </a></h4>
                                            <div class="conut">
                                                ২
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbca81ecd92.jpg"
                                                alt="শুরু হয়েছে শীতের মৌসুম, শীতের ফুলে রঙিন প্রকৃতি"
                                                title="শুরু হয়েছে শীতের মৌসুম, শীতের ফুলে রঙিন প্রকৃতি">

                                            <a href="135.html" class="videoIcon-03"><i class="la la-play"></i></a>

                                            <h4 class="tab_hadding"><a href="135.html"> শুরু হয়েছে শীতের মৌসুম, শীতের
                                                    ফুলে রঙিন প্রকৃতি </a></h4>
                                            <div class="conut">
                                                ৩
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc9d3dd206.jpg"
                                                alt="সীমান্ত থেকে ১৭ ছাগল নিয়ে গেল বিএসএফ, অতঃপর..."
                                                title="সীমান্ত থেকে ১৭ ছাগল নিয়ে গেল বিএসএফ, অতঃপর...">



                                            <h4 class="tab_hadding"><a href="134.html"> সীমান্ত থেকে ১৭ ছাগল নিয়ে গেল
                                                    বিএসএফ, অতঃপর... </a></h4>
                                            <div class="conut">
                                                ৪
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc67cb9310.jpg"
                                                alt="সৌদিতে মঙ্গলবার পর্যন্ত ঝরবে বৃষ্টি, ক্লাস অনলাইনে"
                                                title="সৌদিতে মঙ্গলবার পর্যন্ত ঝরবে বৃষ্টি, ক্লাস অনলাইনে">



                                            <h4 class="tab_hadding"><a href="133.html"> সৌদিতে মঙ্গলবার পর্যন্ত ঝরবে
                                                    বৃষ্টি, ক্লাস অনলাইনে </a></h4>
                                            <div class="conut">
                                                ৫
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc492b2e27.jpg"
                                                alt="রিহ্যাব ফেয়ারে পদ্মা ব্যাংকের বিশেষ গৃহঋণ সেবা"
                                                title="রিহ্যাব ফেয়ারে পদ্মা ব্যাংকের বিশেষ গৃহঋণ সেবা">



                                            <h4 class="tab_hadding"><a href="132.html"> রিহ্যাব ফেয়ারে পদ্মা ব্যাংকের
                                                    বিশেষ গৃহঋণ সেবা </a></h4>
                                            <div class="conut">
                                                ৬
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc4508c1fc.jpg"
                                                alt="সিলেট স্ট্রাইকার্সের সাথে এক্স-সিরামিকস"
                                                title="সিলেট স্ট্রাইকার্সের সাথে এক্স-সিরামিকস">



                                            <h4 class="tab_hadding"><a href="131.html"> সিলেট স্ট্রাইকার্সের সাথে
                                                    এক্স-সিরামিকস </a></h4>
                                            <div class="conut">
                                                ৭
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc423de7a7.jpg"
                                                alt="দেশব্যাপী পালিত হলো টোটাল ফিটনেস ডে"
                                                title="দেশব্যাপী পালিত হলো টোটাল ফিটনেস ডে">



                                            <h4 class="tab_hadding"><a href="130.html"> দেশব্যাপী পালিত হলো টোটাল ফিটনেস
                                                    ডে </a></h4>
                                            <div class="conut">
                                                ৮
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc3f221d50.jpg"
                                                alt="সৃষ্টিশীল কাজে পৃষ্ঠপোষকতা বাড়াতে হবে: সমাজকল্যাণমন্ত্রী"
                                                title="সৃষ্টিশীল কাজে পৃষ্ঠপোষকতা বাড়াতে হবে: সমাজকল্যাণমন্ত্রী">



                                            <h4 class="tab_hadding"><a href="129.html"> সৃষ্টিশীল কাজে পৃষ্ঠপোষকতা
                                                    বাড়াতে হবে: সমাজকল্যাণমন্ত্রী </a></h4>
                                            <div class="conut">
                                                ৯
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc3c8d149a.jpg"
                                                alt="ওটিএ ও আইসিএ অ্যাসোসিয়েশনের কেন্দ্রীয় কার্যনির্বাহী পরিষদের নতুন কমিটি ঘোষণা"
                                                title="ওটিএ ও আইসিএ অ্যাসোসিয়েশনের কেন্দ্রীয় কার্যনির্বাহী পরিষদের নতুন কমিটি ঘোষণা">



                                            <h4 class="tab_hadding"><a href="128.html"> ওটিএ ও আইসিএ অ্যাসোসিয়েশনের
                                                    কেন্দ্রীয় কার্যনির্বাহী পরিষদের নতুন কমিটি ঘোষণা </a></h4>
                                            <div class="conut">
                                                ১০
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc38997946.jpg"
                                                alt="ইতালিতে ভুয়া ‘রেসিডেন্স পারমিট’ বানানোর অভিযোগে বাংলাদেশিসহ আটক ৭"
                                                title="ইতালিতে ভুয়া ‘রেসিডেন্স পারমিট’ বানানোর অভিযোগে বাংলাদেশিসহ আটক ৭">



                                            <h4 class="tab_hadding"><a href="127.html"> ইতালিতে ভুয়া ‘রেসিডেন্স পারমিট’
                                                    বানানোর অভিযোগে বাংলাদেশিসহ আটক ৭ </a></h4>
                                            <div class="conut">
                                                ১১
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc35e0ad29.jpg"
                                                alt="আফ্রিকায় মরুভূমি পাড়ি দিতে গিয়ে পিপাসায় মারা গেল ২৭ অভিবাসী "
                                                title="আফ্রিকায় মরুভূমি পাড়ি দিতে গিয়ে পিপাসায় মারা গেল ২৭ অভিবাসী ">



                                            <h4 class="tab_hadding"><a href="126.html"> আফ্রিকায় মরুভূমি পাড়ি দিতে গিয়ে
                                                    পিপাসায় মারা গেল ২৭ অভিবাসী  </a></h4>
                                            <div class="conut">
                                                ১২
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc32e0f816.jpg"
                                                alt="বিদেশগামীদের ফিঙ্গারপ্রিন্ট গ্রহণ ও সরবরাহ করছে সিআইডি"
                                                title="বিদেশগামীদের ফিঙ্গারপ্রিন্ট গ্রহণ ও সরবরাহ করছে সিআইডি">



                                            <h4 class="tab_hadding"><a href="125.html"> বিদেশগামীদের ফিঙ্গারপ্রিন্ট
                                                    গ্রহণ ও সরবরাহ করছে সিআইডি </a></h4>
                                            <div class="conut">
                                                ১৩
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc3038cf7d.jpg"
                                                alt="আবুধাবিতে লটারিতে ১০৫ কোটি টাকা জিতলেন বাংলাদেশি গাড়িচালক"
                                                title="আবুধাবিতে লটারিতে ১০৫ কোটি টাকা জিতলেন বাংলাদেশি গাড়িচালক">



                                            <h4 class="tab_hadding"><a href="124.html"> আবুধাবিতে লটারিতে ১০৫ কোটি টাকা
                                                    জিতলেন বাংলাদেশি গাড়িচালক </a></h4>
                                            <div class="conut">
                                                ১৪
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc2d70a70d.jpg"
                                                alt="সীমা হামিদকে সম্মানসূচক ডক্টরেট ডিগ্রি প্রদান করল ডব্লিউইউএলএম"
                                                title="সীমা হামিদকে সম্মানসূচক ডক্টরেট ডিগ্রি প্রদান করল ডব্লিউইউএলএম">



                                            <h4 class="tab_hadding"><a href="123.html"> সীমা হামিদকে সম্মানসূচক ডক্টরেট
                                                    ডিগ্রি প্রদান করল ডব্লিউইউএলএম </a></h4>
                                            <div class="conut">
                                                ১৫
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc26d3a8d5.jpg"
                                                alt="সিএসইর শরিয়াহ সূচকে ২ কেম্পানি যুক্ত হলো , বাদ পড়ল ৪টি"
                                                title="সিএসইর শরিয়াহ সূচকে ২ কেম্পানি যুক্ত হলো , বাদ পড়ল ৪টি">



                                            <h4 class="tab_hadding"><a href="122.html"> সিএসইর শরিয়াহ সূচকে ২ কেম্পানি
                                                    যুক্ত হলো , বাদ পড়ল ৪টি </a></h4>
                                            <div class="conut">
                                                ১৬
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc24494ab9.jpg"
                                                alt="সূচকের উঠা-নামায় লেনদেন চলছে" title="সূচকের উঠা-নামায় লেনদেন চলছে">



                                            <h4 class="tab_hadding"><a href="121.html"> সূচকের উঠা-নামায় লেনদেন চলছে
                                                </a></h4>
                                            <div class="conut">
                                                ১৭
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc21684271.jpeg"
                                                alt="এশিয়াটিক ল্যাবরেটরিজের আইপিওতে আবেদন শুরু ১৬ জানুয়ারি"
                                                title="এশিয়াটিক ল্যাবরেটরিজের আইপিওতে আবেদন শুরু ১৬ জানুয়ারি">



                                            <h4 class="tab_hadding"><a href="120.html"> এশিয়াটিক ল্যাবরেটরিজের আইপিওতে
                                                    আবেদন শুরু ১৬ জানুয়ারি </a></h4>
                                            <div class="conut">
                                                ১৮
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc1eca8df4.jpg"
                                                alt="ইন্টারন্যাশনাল লিজিংয়ের তৃতীয় প্রান্তিক প্রকাশ"
                                                title="ইন্টারন্যাশনাল লিজিংয়ের তৃতীয় প্রান্তিক প্রকাশ">



                                            <h4 class="tab_hadding"><a href="119.html"> ইন্টারন্যাশনাল লিজিংয়ের তৃতীয়
                                                    প্রান্তিক প্রকাশ </a></h4>
                                            <div class="conut">
                                                ১৯
                                    ...
                                    <div class="tab-item"> <!-- tab Item Start-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbc1bebc9ae.jpg"
                                                alt="নগদ লভ্যাংশ পাঠিয়েছে ২ কোম্পানি"
                                                title="নগদ লভ্যাংশ পাঠিয়েছে ২ কোম্পানি">



                                            <h4 class="tab_hadding"><a href="118.html"> নগদ লভ্যাংশ পাঠিয়েছে ২ কোম্পানি
                                                </a></h4>
                                            <div class="conut">
                                                ২০
                            ...
                            <div class="tab-pane fade" id="popular" role="tabpanel" aria-labelledby="popular">
                                <div class="news-tavs">
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63babf78d1ec9.jpg"
                                                alt="অপার রহস্য প্রকাশ করলেন বুবলী!" title="অপার রহস্য প্রকাশ করলেন বুবলী!">



                                            <h4 class="tab_hadding"><a href="30.html"> অপার রহস্য প্রকাশ করলেন বুবলী!
                                                </a></h4>
                                            <div class="conut">
                                                ১
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63babbf7ebf03.jpg"
                                                alt="দেশমের চুক্তি বৃদ্ধির পর ভবিষ্যত কি জিদানের কোচিং ক্যারিয়ারের"
                                                title="দেশমের চুক্তি বৃদ্ধির পর ভবিষ্যত কি জিদানের কোচিং ক্যারিয়ারের">



                                            <h4 class="tab_hadding"><a href="16.html"> দেশমের চুক্তি বৃদ্ধির পর ভবিষ্যত
                                                    কি জিদানের কোচিং ক্যারিয়ারের </a></h4>
                                            <div class="conut">
                                                ২
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63babba879925.jpg"
                                                alt="এবার আদালতে মামলা লড়বে রোবট আইনজীবী, যা বিশ্বে প্রথম "
                                                title="এবার আদালতে মামলা লড়বে রোবট আইনজীবী, যা বিশ্বে প্রথম ">



                                            <h4 class="tab_hadding"><a href="15.html"> এবার আদালতে মামলা লড়বে রোবট
                                                    আইনজীবী, যা বিশ্বে প্রথম  </a></h4>
                                            <div class="conut">
                                                ৩
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb5d1c8b70.jpg"
                                                alt="বিশ্বে প্রথম কৃত্রিম গর্ভের সুবিধা, থাকছে সন্তানের উচ্চতা ও বুদ্ধিমত্তা নির্ধারণের সুবিধা "
                                                title="বিশ্বে প্রথম কৃত্রিম গর্ভের সুবিধা, থাকছে সন্তানের উচ্চতা ও বুদ্ধিমত্তা নির্ধারণের সুবিধা ">



                                            <h4 class="tab_hadding"><a href="77.html"> বিশ্বে প্রথম কৃত্রিম গর্ভের
                                                    সুবিধা, থাকছে সন্তানের উচ্চতা ও বুদ্ধিমত্তা নির্ধারণের সুবিধা  </a>
                                            </h4>
                                            <div class="conut">
                                                ৪
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbce8993ce.jpg"
                                                alt="পরীমণির মাদক মামলা স্থগিত থাকবে: আপিল বিভাগ"
                                                title="পরীমণির মাদক মামলা স্থগিত থাকবে: আপিল বিভাগ">



                                            <h4 class="tab_hadding"><a href="99.html"> পরীমণির মাদক মামলা স্থগিত থাকবে:
                                                    আপিল বিভাগ </a></h4>
                                            <div class="conut">
                                                ৫
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb56b75c42.jpg"
                                                alt="হাতির পিঠে চড়ে রাজকীয় বরযাত্রা, কনে এলো পালকিতে"
                                                title="হাতির পিঠে চড়ে রাজকীয় বরযাত্রা, কনে এলো পালকিতে">



                                            <h4 class="tab_hadding"><a href="75.html"> হাতির পিঠে চড়ে রাজকীয় বরযাত্রা,
                                                    কনে এলো পালকিতে </a></h4>
                                            <div class="conut">
                                                ৬
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbae9669437.jpg"
                                                alt="চরভদ্রাসনে যুবককে কুপিয়ে জখম" title="চরভদ্রাসনে যুবককে কুপিয়ে জখম">



                                            <h4 class="tab_hadding"><a href="46.html"> চরভদ্রাসনে যুবককে কুপিয়ে জখম </a>
                                            </h4>
                                            <div class="conut">
                                                ৭
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbea465c94.jpg"
                                                alt="খুলনা বিশ্ববিদ্যালয়: স্বতন্ত্র বৈশিষ্ট্যে সমুজ্জ্বল "
                                                title="খুলনা বিশ্ববিদ্যালয়: স্বতন্ত্র বৈশিষ্ট্যে সমুজ্জ্বল ">



                                            <h4 class="tab_hadding"><a href="107.html"> খুলনা বিশ্ববিদ্যালয়: স্বতন্ত্র
                                                    বৈশিষ্ট্যে সমুজ্জ্বল  </a></h4>
                                            <div class="conut">
                                                ৮
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbaf9ad4100.jpg"
                                                alt="জাবিতে ভূতাত্ত্বিক বিজ্ঞান বিভাগের যৌথ গবেষণা"
                                                title="জাবিতে ভূতাত্ত্বিক বিজ্ঞান বিভাগের যৌথ গবেষণা">



                                            <h4 class="tab_hadding"><a href="50.html"> জাবিতে ভূতাত্ত্বিক বিজ্ঞান
                                                    বিভাগের যৌথ গবেষণা </a></h4>
                                            <div class="conut">
                                                ৯
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbaf5691e53.jpg"
                                                alt="জবি বিএনসিসি ক্যাডেট ও ল্যান্স কর্পোরাল পদে পদোন্নতি পেলেন ৩৫ শিক্ষার্থী"
                                                title="জবি বিএনসিসি ক্যাডেট ও ল্যান্স কর্পোরাল পদে পদোন্নতি পেলেন ৩৫ শিক্ষার্থী">



                                            <h4 class="tab_hadding"><a href="49.html"> জবি বিএনসিসি ক্যাডেট ও ল্যান্স
                                                    কর্পোরাল পদে পদোন্নতি পেলেন ৩৫ শিক্ষার্থী </a></h4>
                                            <div class="conut">
                                                ১০
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bab7a4b11ee.jpg"
                                                alt="২০২৩ সালে কতজন হজে যেতে পারবেন জানালেন ধর্ম প্রতিমন্ত্রী"
                                                title="২০২৩ সালে কতজন হজে যেতে পারবেন জানালেন ধর্ম প্রতিমন্ত্রী">



                                            <h4 class="tab_hadding"><a href="1.html"> ২০২৩ সালে কতজন হজে যেতে পারবেন
                                                    জানালেন ধর্ম প্রতিমন্ত্রী </a></h4>
                                            <div class="conut">
                                                ১১
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb815c3e20.jpg"
                                                alt="সঙ্গীকে নিয়ে মালদ্বীপ ভ্রমণে যে ভুল করলেই বিপদে পড়বেন"
                                                title="সঙ্গীকে নিয়ে মালদ্বীপ ভ্রমণে যে ভুল করলেই বিপদে পড়বেন">



                                            <h4 class="tab_hadding"><a href="84.html"> সঙ্গীকে নিয়ে মালদ্বীপ ভ্রমণে যে
                                                    ভুল করলেই বিপদে পড়বেন </a></h4>
                                            <div class="conut">
                                                ১৪
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbafc4f25b9.jpg"
                                                alt="চবিতে ছাত্রলীগের দুই গ্রুপের সংঘর্ষে সহকারী প্রক্টর আহত"
                                                title="চবিতে ছাত্রলীগের দুই গ্রুপের সংঘর্ষে সহকারী প্রক্টর আহত">



                                            <h4 class="tab_hadding"><a href="51.html"> চবিতে ছাত্রলীগের দুই গ্রুপের
                                                    সংঘর্ষে সহকারী প্রক্টর আহত </a></h4>
                                            <div class="conut">
                                                ১৫
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb6bac0c6d.jpg"
                                                alt="যে কারণে নিয়মিত খালি পেটে পেঁপে খাবেন"
                                                title="যে কারণে নিয়মিত খালি পেটে পেঁপে খাবেন">



                                            <h4 class="tab_hadding"><a href="81.html"> যে কারণে নিয়মিত খালি পেটে পেঁপে
                                                    খাবেন </a></h4>
                                            <div class="conut">
                                                ১৬
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbd1a11894.jpg"
                                                alt="ওয়াসার এমডির ১৪ বাড়ি: দুদকের অগ্রগতি জানতে চাইলেন হাইকোর্ট (ভিডিও)"
                                                title="ওয়াসার এমডির ১৪ বাড়ি: দুদকের অগ্রগতি জানতে চাইলেন হাইকোর্ট (ভিডিও)">



                                            <h4 class="tab_hadding"><a href="100.html"> ওয়াসার এমডির ১৪ বাড়ি: দুদকের
                                                    অগ্রগতি জানতে চাইলেন হাইকোর্ট (ভিডিও) </a></h4>
                                            <div class="conut">
                                                ১৭
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bac0ecbeabd.jpg"
                                                alt="গত ৮ বছরের মধ্যে স্যামসাংয়ের মুনাফায় ধস "
                                                title="গত ৮ বছরের মধ্যে স্যামসাংয়ের মুনাফায় ধস ">



                                            <h4 class="tab_hadding"><a href="33.html"> গত ৮ বছরের মধ্যে স্যামসাংয়ের
                                                    মুনাফায় ধস  </a></h4>
                                            <div class="conut">
                                                ১৮
                                    ...
                                    <div class="tab-item"> <!-- tab Item tart-->
                                        <div class="tab-image tab-border">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbbdf2f83e.jpg"
                                                alt="চিকিৎসা সেবায় বাড়ছে বৈষম্য, গরিবদের চেয়ে ৮ গুণ বেশি খরচ করেন ধনীরা (ভিডিও)"
                                                title="চিকিৎসা সেবায় বাড়ছে বৈষম্য, গরিবদের চেয়ে ৮ গুণ বেশি খরচ করেন ধনীরা (ভিডিও)">



                                            <h4 class="tab_hadding"><a href="95.html"> চিকিৎসা সেবায় বাড়ছে বৈষম্য,
                                                    গরিবদের চেয়ে ৮ গুণ বেশি খরচ করেন ধনীরা (ভিডিও) </a></h4>
                                            <div class="conut">
                                                ২০
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="section_three_bg">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    @foreach ($fastcatPostBig as $FastcatPostBig)
                                        @if (session()->get('language') == 'english')
                                            <div class="secThree_wrpp">
                                                <div class="secThree_image">
                                                    <img class="lazyload" src="{{asset($FastcatPostBig->image)}}"
                                                        data-src="{{asset($FastcatPostBig->image)}}"
                                                        alt="{{$FastcatPostBig->title_en}}" title="{{$FastcatPostBig->title_en}}">
                                        ...
                                        @else
                                            <div class="secThree_wrpp">
                                                <div class="secThree_image">
                                                    <img class="lazyload" src="{{asset($FastcatPostBig->image)}}"
                                                        data-src="{{asset($FastcatPostBig->image)}}"
                                                        alt="{{$FastcatPostBig->title_bn}}" title="{{$FastcatPostBig->title_bn}}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    @foreach ($fastcatPostSm as $FastcatPostSm)
                                        @if (session()->get('language') == 'english')
                                            <div class="secThree_item">
                                                <div class="secThree_image2">
                                                    <img class="lazyload" src="{{asset($FastcatPostSm->image)}}"
                                                        data-src="{{asset($FastcatPostSm->image)}}"
                                                        alt="{{$FastcatPostSm->title_en}}" title="{{$FastcatPostSm->title_en}}">
                                                </div><!-- End image-->


                                                <h4 class="secThree_title2">
                                                    <a href="#">{{$FastcatPostSm->title_en}}</a>
                                                </h4>
                                            </div>
                                        @else
                                            <div class="secThree_item">
                                                <div class="secThree_image2">
                                                    <img class="lazyload" src="{{asset($FastcatPostSm->image)}}"
                                                        data-src="{{asset($FastcatPostSm->image)}}"
                                                        alt="{{$FastcatPostSm->title_bn}}" title="{{$FastcatPostSm->title_bn}}">
                                                </div><!-- End image-->


                                                <h4 class="secThree_title2">
                                                    <a href="#">{{$FastcatPostSm->title_bn}}</a>
                                                </h4>
                                            </div>
                                        @endif
                                    @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <h4 class="more_news"><a href="news/category/national.html"> আরো খবর <i
                                                        class="la la-angle-double-right"></i> </a></h4>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="section_three_bg">
                            <h2 class="themesBazar_cat01">
                                @if (session()->get('language') == 'english')
                                    <a href="news/category/politics.html">{{$secondtCat->category_en}}</a>
                                @else
                                    <a href="news/category/politics.html">{{$secondtCat->category_bn}}</a>
                                @endif
                            </h2>

                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    @foreach ($secondCatPostBig as $SecondCatPostBig)
                                        @if (session()->get('language') == 'english')
                                            <div class="secThree_wrpp">
                                                <div class="secThree_image">
                                                    <img class="lazyload" src="{{asset($SecondCatPostBig->image)}}"
                                                        data-src="{{asset($SecondCatPostBig->image)}}"
                                                        alt="{{$SecondCatPostBig->title_en}}"
                                                        title="{{$SecondCatPostBig->title_en}}">

                                                    <a href="10.html" class="video-icon1"><i class="la la-play"></i></a>

                                                </div>
                                                <h4 class="secThree_title">
                                                    <a href="10.html">{{$SecondCatPostBig->title_en}}</a>
                                                </h4>
                                                <div class="content_details">
                                                    এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো
                                                    নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                                    ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ।... <a href="#"></a> <a
                                                        href="10.html"> বিস্তারিত</a>
                                                </div>
                                        ...
                                        @else
                                            <div class="secThree_wrpp">
                                                <div class="secThree_image">
                                                    <img class="lazyload" src="{{asset($SecondCatPostBig->image)}}"
                                                        data-src="{{asset($SecondCatPostBig->image)}}"
                                                        alt="{{$SecondCatPostBig->title_bn}}"
                                                        title="{{$SecondCatPostBig->titl_bn}}">

                                                    <a href="10.html" class="video-icon1"><i class="la la-play"></i></a>

                                                </div>
                                                <h4 class="secThree_title">
                                                    <a href="10.html">{{$SecondCatPostBig->title_bn}}</a>
                                                </h4>
                                                <div class="content_details">
                                                    এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো
                                                    নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                                    ডেমো নিউজ।... <a href="#"></a> <a href="10.html"> বিস্তারিত</a>
                                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    @foreach ($secondCatPostSm as $SecondCatPostSm)
                                        @if (session()->get('language') == 'english')
                                            <div class="secThree_item">
                                                <div class="secThree_image2">
                                                    <img class="lazyload" src="{{asset($SecondCatPostSm->image)}}"
                                                        data-src="{{asset($SecondCatPostSm->image)}}"
                                                        alt="{{$SecondCatPostSm->title_en}}" title="{{$SecondCatPostSm->title_en}}">
                                                </div><!-- End image-->


                                                <h4 class="secThree_title2">
                                                    <a href="9.html">{{$SecondCatPostSm->title_en}}</a>
                                                </h4>
                                            </div>
                                        @else
                                            <div class="secThree_item">
                                                <div class="secThree_image2">
                                                    <img class="lazyload" src="{{asset($SecondCatPostSm->image)}}"
                                                        data-src="{{asset($SecondCatPostSm->image)}}"
                                                        alt="{{$SecondCatPostSm->title_bn}}" title="{{$SecondCatPostSm->title_bn}}">
                                                </div><!-- End image-->


                                                <h4 class="secThree_title2">
                                                    <a href="9.html">{{$SecondCatPostSm->title_bn}}</a>
                                                </h4>
                                            </div>
                                        @endif
                                    @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <h4 class="more_news"><a href="news/category/politics.html"> আরো খবর <i
                                                        class="la la-angle-double-right"></i> </a></h4>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        @if (session()->get('language') == 'english')
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/international.html"> {{$thirdCat->category_en}} </a>
                            </h2>
                        @else
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/international.html"> {{$thirdCat->category_bn}} </a>
                            </h2>
                        @endif

                        <div class="secFour_wrpp">
                            @foreach ($thirdCatPostBig as $ThirdCatPostBig)
                                @if (session()->get('language') == 'english')

                                    <div class="secFour_image">
                                        <img class="lazyload" src="{{asset($ThirdCatPostBig->image)}}"
                                            data-src="{{asset($ThirdCatPostBig->image)}}" alt="{{$ThirdCatPostBig->title_en}}"
                                            title="{{$ThirdCatPostBig->title_en}}">



                                    </div>
                                    <h4 class="secFour_title">
                                        <a href="133.html">{{$ThirdCatPostBig->title_en}}</a>
                                    </h4>
                                    <div class="content_details">
                                        ধীরে ধীরে বদলে যাচ্ছে সৌদি আরবের আবহাওয়া। কয়েক দিন আগেই মক্কার পাহাড়ি এলাকা গাছপালায়
                                        সবুজ হয়ে যাওয়ার... <a href="#"></a> <a href="133.html"> বিস্তারিত</a>
                                    </div>
                                @else
                                    <div class="secFour_image">
                                        <img class="lazyload" src="{{asset($ThirdCatPostBig->image)}}"
                                            data-src="{{asset($ThirdCatPostBig->image)}}" alt="{{$ThirdCatPostBig->title_bn}}"
                                            title="{{$ThirdCatPostBig->title_bn}}">



                                    </div>
                                    <h4 class="secFour_title">
                                        <a href="133.html">{{$ThirdCatPostBig->title_bn}}</a>
                                    </h4>
                                    <div class="content_details">
                                        ধীরে ধীরে বদলে যাচ্ছে সৌদি আরবের আবহাওয়া। কয়েক দিন আগেই মক্কার পাহাড়ি এলাকা গাছপালায়
                                        সবুজ হয়ে যাওয়ার... <a href="#"></a> <a href="133.html"> বিস্তারিত</a>
                            ...
                            @foreach ($thirdCatPostSm as $ThirdCatPostSm)
                                @if (session()->get('language') == 'english')
                                    <div class="secFour_item">
                                        <div class="secFour_image2">
                                            <img class="lazyload" src="{{asset($ThirdCatPostSm->image)}}"
                                                data-src="{{asset($ThirdCatPostSm->image)}}" alt="{{$ThirdCatPostSm->title_en}}"
                                                title="{{$ThirdCatPostSm->title_en}}">

                                        </div><!-- End image-->


                                        <h4 class="secFour_title2">
                                            <a href="15.html"> {{$ThirdCatPostSm->title_en}} </a>
                                        </h4>
                                    </div>
                                @else
                                    <div class="secFour_item">
                                        <div class="secFour_image2">
                                            <img class="lazyload" src="{{asset($ThirdCatPostSm->image)}}"
                                                data-src="{{asset($ThirdCatPostSm->image)}}" alt="{{$ThirdCatPostSm->title_bn}}"
                                                title="{{$ThirdCatPostSm->title_bn}}">

                                        </div><!-- End image-->


                                        <h4 class="secFour_title2">
                                            <a href="15.html"> {{$ThirdCatPostSm->title_bn}} </a>
                                        </h4>
                                    </div>
                                @endif
                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/international.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="secFour_wrpp">
                            ...
                            @if (session()->get('language')=='english')
                                <h2 class="themesBazar_cat01">
                                    <a href="news/category/it.html"> {{$fourthCat->category_en}} </a>
                                </h2>
                            @else
                                <h2 class="themesBazar_cat01">
                                    <a href="news/category/it.html"> {{$fourthCat->category_bn}} </a>
                                </h2>
                            @endif

                            @foreach ($fourthCatPostBig as $FourthCatPostBig)
                                @if (session()->get('language')=='english')
                                    <div class="secFour_image">
                                        <img class="lazyload" src="{{asset($FourthCatPostBig->image)}}"
                                            data-src="{{asset($FourthCatPostBig->image)}}"
                                            alt="{{$FourthCatPostBig->title_en}}"
                                            title="{{$FourthCatPostBig->title_en}}">

                                    </div>
                                    <h4 class="secFour_title">
                                        <a href="36.html"> {{$FourthCatPostBig->title_en}} </a>
                                    </h4>
                                    <div class="content_details">
                                        এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                        ডেমো নিউজ।... <a href="#"></a> <a href="36.html"> বিস্তারিত</a>
                                    </div>
                                @else
                                <div class="secFour_image">
                                    <img class="lazyload" src="{{asset($FourthCatPostBig->image)}}"
                                        data-src="{{asset($FourthCatPostBig->image)}}"
                                        alt="{{$FourthCatPostBig->title_bn}}"
                                        title="{{$FourthCatPostBig->title_bn}}">

                                </div>
                                <h4 class="secFour_title">
                                    <a href="36.html"> {{$FourthCatPostBig->title_bn}} </a>
                                </h4>
                                <div class="content_details">
                                    এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                    ডেমো নিউজ।... <a href="#"></a> <a href="36.html"> বিস্তারিত</a>
                            ...
                            @foreach ($fourthCatPostSm as $FourthCatPostSm)
                                @if (session()->get('language')=='english')
                                    <div class="secFour_item">
                                        <div class="secFour_image2">
                                            <img class="lazyload" src="{{asset($FourthCatPostSm->image)}}"
                                                data-src="{{asset($FourthCatPostSm->image)}}"
                                                alt="{{$FourthCatPostSm->title_en}} " title="{{$FourthCatPostSm->title_en}}">

                                        </div><!-- End image-->


                                        <h4 class="secFour_title2">
                                            <a href="35.html"> {{$FourthCatPostSm->title_en}} </a>
                                        </h4>
                                    </div>
                                @else
                                <div class="secFour_item">
                                    <div class="secFour_image2">
                                        <img class="lazyload" src="{{asset($FourthCatPostSm->image)}}"
                                            data-src="{{asset($FourthCatPostSm->image)}}"
                                            alt="{{$FourthCatPostSm->title_bn}} " title="{{$FourthCatPostSm->title_bn}}">

                                    </div><!-- End image-->


                                    <h4 class="secFour_title2">
                                        <a href="35.html"> {{$FourthCatPostSm->title_bn}} </a>
                                    </h4>
                                </div>
                                @endif
                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/it.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="facebook-content">
                            ...
                            <iframe
                                src="https://www.facebook.com/plugins/page.php?href=https://www.facebook.com/themesbazar&amp;tabs=timeline&amp;width=400&amp;height=270&amp;small_header=false&amp;adapt_container_width=true&amp;hide_cover=false&amp;show_facepile=true&amp;appId=334182264340964"
                                width="400" height="270" style="border:none;overflow:hidden" scrolling="no" frameborder="0"
                        ...
                        <div class="facebook-content">
                            ...
                            <a class="twitter-timeline" data-width="400" data-height="270" data-dnt="true"
                                data-theme="light" href="https://www.twitter.com/themesbazar"> </a>
        ...
        <!--==========ThemesBazar=============
                                                                                        Section Five Start
                                                                            ==============ThemesBazar============-->
        <section class="section_five secFive_color">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="secFive_cat">
                            @if (session()->get('language')=='english')
                                <a href="news/category/entertainment.html"> {{$fifththCat->category_en}} </a>
                            @else
                                <a href="news/category/entertainment.html"> {{$fifththCat->category_bn}} </a>
                            @endif
                        </div>
                        <div class="themesBazar_news">
                            <div class="secFive_wrpp">
                                <div class="row">
                                    @foreach ($fifthCatPostBig as $FifthCatPostBig)
                                        @if (session()->get('language')=='english')
                                            <div class="col-lg-5 col-md-5">
                                                <h4 class="secFive_title">
                                                    <a href="31.html"> {{$FifthCatPostBig->title_en}} </a>
                                                </h4>

                                                <div class="secFive_content">
                                                    এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো
                                                    নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                                    ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা
                                                    একটা ডেমো নিউজ। এটা একটা ড... <a href="#"></a> <a href="31.html">
                                                        বিস্তারিত</a>
                                                </div>
                                            ...
                                            <div class="col-lg-7 col-md-7">
                                                ...
                                                <div class="secFive_image">
                                                    <img class="lazyload" src="{{asset($FifthCatPostBig->image)}}"
                                                        data-src="{{asset($FifthCatPostBig->image)}}"
                                                        alt="{{$FifthCatPostBig->title_en}}"
                                                        title="{{$FifthCatPostBig->title_en}}">
                                        ...
                                        @else
                                            <div class="col-lg-5 col-md-5">
                                                <h4 class="secFive_title">
                                                    <a href="31.html"> {{$FifthCatPostBig->title_bn}} </a>
                                                </h4>
                                            ...
                                            <div class="col-lg-7 col-md-7">
                                                ...
                                                <div class="secFive_image">
                                                    <img class="lazyload" src="{{asset($FifthCatPostBig->image)}}"
                                                        data-src="{{asset($FifthCatPostBig->image)}}"
                                                        alt="{{$FifthCatPostBig->title_bn}}"
                                                        title="{{$FifthCatPostBig->title_bn}}">

                                                </div>
                                            </div>
                                        @endif
                                    @endforeach<!--End col-5-->
                                </div>
                        ...
                        <div class="themesBazar_news2">
                            <div class="secFive_wrpp2">
                                @foreach ($fifthCatPostBig as $FifthCatPostBig)
                                    @if (session()->get('language')=='english')
                                        <div class="secFive_image2">
                                            <img class="lazyload" src="{{asset($FifthCatPostBig->image)}}"
                                                data-src="{{asset($FifthCatPostBig->image)}}"
                                                alt="{{$FifthCatPostBig->title_en}}"
                                                title="{{$FifthCatPostBig->title_en}}">
                        ...
                        </div><!--End themesBazar_news2 -->
                    </div><!--End col-8 -->

                    <div class="col-lg-4 col-md-4">
                        <div class="secFive_wrpp3">
                            <div class="secFive_cat">
                                <a href="news/category/lifestyle.html"> লাইফস্টাইল </a>
                            </div>


                            <div class="secFive_image4">
                                <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                    data-src="https://themebazar.xyz/latestscript/public/postimages/63bbca81ecd92.jpg"
                                    alt="শুরু হয়েছে শীতের মৌসুম, শীতের ফুলে রঙিন প্রকৃতি"
                                    title="শুরু হয়েছে শীতের মৌসুম, শীতের ফুলে রঙিন প্রকৃতি">
                            ...
                            <h4 class="secFive_title4">
                                <a href="135.html"> শুরু হয়েছে শীতের মৌসুম, শীতের ফুলে রঙিন প্রকৃতি </a>
                            </h4>



                            <div class="secFive_item">
                                <div class="secFive_image3">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb71026194.jpg"
                                        alt="রান্নায় মরিচের গুঁড়া বেশি পড়ে গেলে যা যা করবেন"
                                        title="রান্নায় মরিচের গুঁড়া বেশি পড়ে গেলে যা যা করবেন">

                                </div><!-- End image-->


                                <h4 class="secFive_title3">
                            ...
                            <div class="secFive_moreNews">
                                <a href="news/category/lifestyle.html"> আরো খবর </a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_wrpp">
                                        <div class="secThree_image">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb02253bf5.jpg"
                                                alt="চবি ছাত্রলীগের সংঘর্ষে ক্যাম্পসে উত্তেজনা"
                                                title="চবি ছাত্রলীগের সংঘর্ষে ক্যাম্পসে উত্তেজনা">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbaff425fcb.jpg"
                                                alt="গুচ্ছ পদ্ধতিতে ভর্তি, প্রথম অবস্থানে বেগম রোকেয়া বিশ্ববিদ্যালয়"
                                                title="গুচ্ছ পদ্ধতিতে ভর্তি, প্রথম অবস্থানে বেগম রোকেয়া বিশ্ববিদ্যালয়">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="52.html"> গুচ্ছ পদ্ধতিতে ভর্তি, প্রথম অবস্থানে বেগম রোকেয়া
                                                বিশ্ববিদ্যালয় </a>
                                        </h4>
                                    </div><!--End item-->
                                    <div class="secThree_item">
                                        ...
                                        <h4 class="secThree_title2">
                                            <a href="51.html"> চবিতে ছাত্রলীগের দুই গ্রুপের সংঘর্ষে সহকারী প্রক্টর আহত
                                            </a>
                                        </h4>
                                    </div><!--End item-->
                                    <div class="secThree_item">
                                    ...
                                    <div class="secThree_item">
                                        ...
                                        <h4 class="secThree_title2">
                                            <a href="49.html"> জবি বিএনসিসি ক্যাডেট ও ল্যান্স কর্পোরাল পদে পদোন্নতি
                                                পেলেন ৩৫ শিক্ষার্থী </a>
                                        </h4>
                                    </div><!--End item-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <h4 class="more_news"><a href="news/category/campus.html"> আরো খবর <i
                                                        class="la la-angle-double-right"></i> </a></h4>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="section_three_bg">
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/media.html"> গণমাধ্যম </a>
                            </h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_wrpp">
                                        <div class="secThree_image">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb152d03e0.jpg"
                                                alt="লুডুতে চ্যাম্পিয়ন তাপসী রাবেয়া" title="লুডুতে চ্যাম্পিয়ন তাপসী রাবেয়া">
                                        ...
                                        <div class="content_details">
                                            এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো
                                            নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                            ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ।...
                                            <a href="#"></a> <a href="58.html"> বিস্তারিত </a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb11ef3664.jpg"
                                                alt="উৎসাহ-উদ্দীপনায় শুরু জাতীয় প্রেস ক্লাবের নির্বাচন"
                                                title="উৎসাহ-উদ্দীপনায় শুরু জাতীয় প্রেস ক্লাবের নির্বাচন">
                                        </div><!-- End image-->
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb0f0554f8.jpg"
                                                alt="প্রখ্যাত টিভি সাংবাদিক বারবারা ওয়াল্টারস আর নেই"
                                                title="প্রখ্যাত টিভি সাংবাদিক বারবারা ওয়াল্টারস আর নেই">
                                        </div><!-- End image-->
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb0c4d6218.jpg"
                                                alt="গত ২০ বছরে প্রায় ১৭শ সাংবাদিক নিহত হয়েছেন"
                                                title="গত ২০ বছরে প্রায় ১৭শ সাংবাদিক নিহত হয়েছেন">
                                        </div><!-- End image-->
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb098d7307.jpg"
                                                alt="চ্যানেল টুয়েন্টিফোরের প্রতিযোগিতার বিজয়ীদের পুরস্কার বিতরণ"
                                                title="চ্যানেল টুয়েন্টিফোরের প্রতিযোগিতার বিজয়ীদের পুরস্কার বিতরণ">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="54.html"> চ্যানেল টুয়েন্টিফোরের প্রতিযোগিতার বিজয়ীদের পুরস্কার
                                                বিতরণ </a>
                                        </h4>
                                    </div><!--End item-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <h4 class="more_news"><a href="news/category/media.html"> আরো খবর <i
                                                        class="la la-angle-double-right"></i> </a></h4>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <h2 class="themesBazar_cat01">
                            <a href="news/category/bangladesh.html"> সারাদেশ </a>
                        </h2>
                        ...
                        <div class="row">
                            ...
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="division_wrpp"><!-- secTwo Wrpp start-->
                            ...
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="division_wrpp"><!-- secTwo Wrpp start-->
                                    <div class="division_image">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63bbaf12566b4.jpg"
                                            alt="এই শীতে ভাঙন আতঙ্কে দিন কাটছে তাদের"
                                            title="এই শীতে ভাঙন আতঙ্কে দিন কাটছে তাদের">
                            ...
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="division_wrpp"><!-- secTwo Wrpp start-->
                                    <div class="division_image">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63bbaed978b73.jpg"
                                            alt="অ্যাম্বুলেন্স চাপায় প্রাণ গেল ভ্যানচালকের"
                                            title="অ্যাম্বুলেন্স চাপায় প্রাণ গেল ভ্যানচালকের">
                            ...
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="division_wrpp"><!-- secTwo Wrpp start-->
                                    <div class="division_image">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63bbae475b3c6.jpg"
                                            alt="সাভারের কলমায় লেগুনা-মিনিবাস সংঘর্ষে ৩ জন নিহত"
                                            title="সাভারের কলমায় লেগুনা-মিনিবাস সংঘর্ষে ৩ জন নিহত">
                            ...
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="division_wrpp"><!-- secTwo Wrpp start-->
                                    <div class="division_image">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63bbae082146d.jpg"
                                            alt="কাশিমপুর কারাগারে ধর্ষণ মামলার আসামির ফাঁসি কার্যকর"
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <form class="division" action="https://themebazar.xyz/latestscript/all/country/news" method="get">
                            <input type="hidden" name="_token" value="XC4ILifOmfT3xq8cnA89uc2nGBl3TmhKmTS4steR">



                            <div class="input-division">
                                <select class="form-control" name="divi_id">
                                    <option class="disabled selected">--বিভাগ--</option>
                            ...
                            <div class="input-division">
                                ...
                                <select class="form-control" name="dist_id" id="dist_id">
                                    <option class="disabled selected">--জেলা--</option>
                                </select>
                            ...
                            <div class="input-division">
                                ...
                                <select name="thana_id" id="thana_id" style="margin-top: 10px">
        ...
        <section class="section_seven">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <div class="row">
                            ...
                            <div class="themesBazar-1 themesBazar-m2">
                                <div class="secSeven_wrpp"><!--  Wrpp start-->
                                    <div class="secSeven_image2">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63babd7f86185.jpg"
                                            alt="যুক্তরাষ্ট্রের কোচ হওয়ার ‘আকর্ষণীয়’ প্রস্তাব ফিরিয়ে দিলেন জিদান"
                                            title="যুক্তরাষ্ট্রের কোচ হওয়ার ‘আকর্ষণীয়’ প্রস্তাব ফিরিয়ে দিলেন জিদান">



                                    </div>
                                    <h5 class="secSeven_title2 ">
                                        <a href="22.html"> যুক্তরাষ্ট্রের কোচ হওয়ার ‘আকর্ষণীয়’ প্রস্তাব ফিরিয়ে দিলেন
                                            জিদান </a>
                                    </h5>
                            ...
                            </div><!-- End ThemesBazar_col-->
                            <div class="themesBazar-1 themesBazar-m2">
                                <div class="secSeven_wrpp"><!--  Wrpp start-->
                                    <div class="secSeven_image2">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63babd3dec05c.jpg"
                                            alt="অবশেষে জানা গেলো, সৌদি আরবে কবে অভিষেক হচ্ছে রোনালদোর"
                                            title="অবশেষে জানা গেলো, সৌদি আরবে কবে অভিষেক হচ্ছে রোনালদোর">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="secSeven_wrpp">

                            <div class="secSeven_image">
                                <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                    data-src="https://themebazar.xyz/latestscript/public/postimages/63babdb5775a7.jpg"
                                    alt="রেকর্ড পাঁচবার বর্ষসেরা প্লেমেকার অ্যাওয়ার্ড জিতলেন মেসি"
                                    title="রেকর্ড পাঁচবার বর্ষসেরা প্লেমেকার অ্যাওয়ার্ড জিতলেন মেসি">



                            </div>
                            <h4 class="secSeven_title">
                                <a href="23.html"> রেকর্ড পাঁচবার বর্ষসেরা প্লেমেকার অ্যাওয়ার্ড জিতলেন মেসি </a>
                            </h4>
                            <div class="content_details">
                                এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো
                                নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ।
                                এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                ড... <a href="#"></a> <a href="23.html"> বিস্তারিত</a>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="themesBazar-1 themesBazar-m2">
                                <div class="secSeven_wrpp"><!--  Wrpp start-->
                                    <div class="secSeven_image2">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63babd0b8ef62.jpg"
                                            alt="শেষ ষোলোতে সহজ প্রতিপক্ষ পেল বার্সা, কঠিন চ্যালেঞ্জের সামনে রিয়াল মাদ্রিদ"
                                            title="শেষ ষোলোতে সহজ প্রতিপক্ষ পেল বার্সা, কঠিন চ্যালেঞ্জের সামনে রিয়াল মাদ্রিদ">



                                    </div>
                                    <h5 class="secSeven_title2 ">
                                        <a href="20.html"> শেষ ষোলোতে সহজ প্রতিপক্ষ পেল বার্সা, কঠিন চ্যালেঞ্জের সামনে
                                            রিয়াল মাদ্রিদ </a>
                                    </h5>
                            ...
                            <div class="themesBazar-1 themesBazar-m2">
                                <div class="secSeven_wrpp"><!--  Wrpp start-->
                                    <div class="secSeven_image2">
                                        <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://themebazar.xyz/latestscript/public/postimages/63babcb8be11f.JPG"
                                            alt="আম্পায়ারের সিদ্ধান্তে ক্ষুব্ধ হয়ে তেড়ে গেলেন সাকিব"
                                            title="আম্পায়ারের সিদ্ধান্তে ক্ষুব্ধ হয়ে তেড়ে গেলেন সাকিব">
        ...
        <section class="section_eight">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <h2 class="themesBazar_cat01">
                            <a href="news/category/jobs.html"> চাকুরী </a>
                        </h2>

                        <div class="secEight_wrpp">



                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bd9b6a47465.jpg"
                                        alt="৫ ধরনের ছুটির সুবিধাসহ আর্থিক প্রতিষ্ঠানে চাকরির সুযোগ"
                                        title="৫ ধরনের ছুটির সুবিধাসহ আর্থিক প্রতিষ্ঠানে চাকরির সুযোগ">
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb21526f8c.jpg"
                                        alt="শাহজালাল ইসলামী ব্যাংকে চাকরির সুযোগ, থাকছে আকর্ষণীয় বেতন"
                                        title="শাহজালাল ইসলামী ব্যাংকে চাকরির সুযোগ, থাকছে আকর্ষণীয় বেতন">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb1f0065d1.jpg"
                                        alt="কর্ণফুলী গ্রুপে চাকরির সুযোগ, বেতন ২২ হাজার"
                                        title="কর্ণফুলী গ্রুপে চাকরির সুযোগ, বেতন ২২ হাজার">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb1c4e784c.jpg"
                                        alt="জাপান টোবাকো ইন্টারন্যাশনালে চাকরির সুযোগ, আবেদন করুন আজই"
                                        title="জাপান টোবাকো ইন্টারন্যাশনালে চাকরির সুযোগ, আবেদন করুন আজই">
                                </div><!-- End image-->


                                <h4 class="secEight_title">
                                    <a href="60.html"> জাপান টোবাকো ইন্টারন্যাশনালে চাকরির সুযোগ, আবেদন করুন আজই </a>
                                </h4>
                            </div><!--End Itme-->
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/jobs.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <h2 class="themesBazar_cat01">
                            <a href="news/category/religion.html"> ধর্ম </a>
                        </h2>
                        ...
                        <div class="secEight_wrpp">
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb3bea6415.jpg"
                                        alt="কয়জন বাংলাদেশি হজে যেতে পারবেন, জানা যাবে ৯ জানুয়ারি "
                                        title="কয়জন বাংলাদেশি হজে যেতে পারবেন, জানা যাবে ৯ জানুয়ারি ">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb37e58c78.jpg"
                                        alt="রমজানের সম্ভাব্য তারিখ ঘোষণা করল আরব আমিরাত"
                                        title="রমজানের সম্ভাব্য তারিখ ঘোষণা করল আরব আমিরাত">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb35846828.jpg"
                                        alt="দুধ পানের সময় যে দোয়া পড়তে হয়" title="দুধ পানের সময় যে দোয়া পড়তে হয়">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb32a92d4d.jpg"
                                        alt="যে দোয়া পড়লে শান্ত থাকবে আপনার মন" title="যে দোয়া পড়লে শান্ত থাকবে আপনার মন">
                                </div><!-- End image-->
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/religion.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="secEight_wrpp">
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb4ce99874.jpg"
                                        alt="অনুমোদন পেয়েছে উদ্ভাবিত উচ্চ ফলনশীল নতুন ধানের জাত (ভিডিও)"
                                        title="অনুমোদন পেয়েছে উদ্ভাবিত উচ্চ ফলনশীল নতুন ধানের জাত (ভিডিও)">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb4960f1e2.jpg"
                                        alt="রোজেলা চাষে আগ্রহ বেড়েছে কৃষকের (ভিডিও)"
                                        title="রোজেলা চাষে আগ্রহ বেড়েছে কৃষকের (ভিডিও)">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb46815d05.jpg"
                                        alt="প্রথমবারের মতো বেসরকারিভাবে গমের নতুন জাত উদ্ভাবন (ভিডিও)"
                                        title="প্রথমবারের মতো বেসরকারিভাবে গমের নতুন জাত উদ্ভাবন (ভিডিও)">
                                </div><!-- End image-->
                            ...
                            <div class="secEight_item">
                                <div class="secEight_image">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb43a2faab.jpg"
                                        alt="এবার বৃষ্টিসহ শৈত্যপ্রবাহের আভাস (ভিডিও)"
                                        title="এবার বৃষ্টিসহ শৈত্যপ্রবাহের আভাস (ভিডিও)">
                                </div><!-- End image-->
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/agriculture.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
        ...
        <!--==========ThemesBazar=============
                                                                                      Video Section  Start
                                                                            ==============ThemesBazar============-->
        <section class="video_section video_color">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="secFive_cat">
                            <a href="https://themebazar.xyz/laranewspaper/all/video/gallery"> ভিডিও গ্যালারী </a>
                        </div>
                        <div class="themesBazar_video">


                            <div class="video_wrpp">
                                <div class="video_thumbnail">
                                    <a href="https://www.youtube.com/watch?v=ge4TfSSUnlc" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/ge4TfSSUnlc/mqdefault.jpg">
                                    </a>
                                    <a href="https://www.youtube.com/watch?v=ge4TfSSUnlc" class="video-icon1 popup "><i
                                            class="la la-play"></i></a>
                                </div>
                            </div><!--End secFive_wrpp -->
                            <div class="video_wrpp">
                                <div class="video_thumbnail">
                                    <a href="https://www.youtube.com/watch?v=rkpzYNB6xks" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/rkpzYNB6xks/mqdefault.jpg">
                                    </a>
                                    <a href="https://www.youtube.com/watch?v=rkpzYNB6xks" class="video-icon1 popup "><i
                                            class="la la-play"></i></a>
                                </div>
                            </div><!--End secFive_wrpp -->
                            <div class="video_wrpp">
                                <div class="video_thumbnail">
                                    <a href="https://www.youtube.com/watch?v=Z1eA0kS8poE" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/Z1eA0kS8poE/mqdefault.jpg">
                                    </a>
                                    <a href="https://www.youtube.com/watch?v=Z1eA0kS8poE" class="video-icon1 popup "><i
                                            class="la la-play"></i></a>
                                </div>
                            </div><!--End secFive_wrpp -->
                            <div class="video_wrpp">
                                <div class="video_thumbnail">
                                    <a href="https://www.youtube.com/watch?v=fN21oOdni_c" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/fN21oOdni_c/mqdefault.jpg">
                                    </a>
                                    <a href="https://www.youtube.com/watch?v=fN21oOdni_c" class="video-icon1 popup "><i
                                            class="la la-play"></i></a>
                                </div>
                            </div><!--End secFive_wrpp -->
                            <div class="video_wrpp">
                                <div class="video_thumbnail">
                                    <a href="https://www.youtube.com/watch?v=jG8PY8-qCII" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/jG8PY8-qCII/mqdefault.jpg">
                                    </a>
                                    <a href="https://www.youtube.com/watch?v=jG8PY8-qCII" class="video-icon1 popup "><i
                                            class="la la-play"></i></a>
                                </div>
                            </div><!--End secFive_wrpp -->
                            <div class="video_wrpp">
                                <div class="video_thumbnail">
                                    <a href="https://www.youtube.com/watch?v=rDYdeq3JW_E" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/rDYdeq3JW_E/mqdefault.jpg">
                                    </a>
                                    <a href="https://www.youtube.com/watch?v=rDYdeq3JW_E" class="video-icon1 popup "><i
                                            class="la la-play"></i></a>
                                </div>
                            </div><!--End secFive_wrpp -->
                        ...
                        <div class="themesBazar_video2">


                            <div class="video_wrpp2">
                                <div class="video_thumbnail2">
                                    <a href="https://www.youtube.com/watch?v=ge4TfSSUnlc" class="video-icon1 popup "><img
                                            class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                            data-src="https://img.youtube.com/vi/ge4TfSSUnlc/mqdefault.jpg">
                                    </a>
                                ...
                                <h4 class="video_title">
                                    <a href="https://www.youtube.com/watch?v=ge4TfSSUnlc" class="video-icon1 popup ">
                                        কংগ্রেস সভাপতির দায়িত্ব </a>
                                </h4>
                            ...
                            <div class="video_wrpp2">
                                ...
                                <h4 class="video_title">
                                    <a href="https://www.youtube.com/watch?v=rkpzYNB6xks" class="video-icon1 popup ">
                                        কংগ্রেস সভাপতির দায়িত্ব </a>
                                </h4>
                            ...
                            <div class="video_wrpp2">
                                ...
                                <h4 class="video_title">
                                    <a href="https://www.youtube.com/watch?v=Z1eA0kS8poE" class="video-icon1 popup ">
                                        কংগ্রেস সভাপতির দায়িত্ব </a>
                                </h4>
                            ...
                            <div class="video_wrpp2">
                                ...
                                <h4 class="video_title">
                                    <a href="https://www.youtube.com/watch?v=fN21oOdni_c" class="video-icon1 popup ">
                                        কংগ্রেস সভাপতির দায়িত্ব </a>
                                </h4>
                            ...
                            <div class="video_wrpp2">
                                ...
                                <h4 class="video_title">
                                    <a href="https://www.youtube.com/watch?v=jG8PY8-qCII" class="video-icon1 popup ">
                                        কংগ্রেস সভাপতির দায়িত্ব </a>
                                </h4>
                            ...
                            <div class="video_wrpp2">
                                ...
                                <h4 class="video_title">
                                    <a href="https://www.youtube.com/watch?v=rDYdeq3JW_E" class="video-icon1 popup ">
                                        কংগ্রেস সভাপতির দায়িত্ব </a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="secFive_wrpp3">
                            <div class="secFive_cat">
                                <a href="news/category/feature.html"> ফিচার </a>
                            </div>
                            ...
                            <h4 class="secFive_title4">
                                <a href="77.html"> বিশ্বে প্রথম কৃত্রিম গর্ভের সুবিধা, থাকছে সন্তানের উচ্চতা ও
                                    বুদ্ধিমত্তা নির্ধারণের সুবিধা  </a>
                            </h4>
                            ...
                            <div class="secFive_item">
                                <div class="secFive_image3">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb59e9b94b.jpg"
                                        alt="বিশ্বের সবচেয়ে দামি ভেড়া যেখানে " title="বিশ্বের সবচেয়ে দামি ভেড়া যেখানে ">
                            ...
                            <div class="secFive_item">
                                <div class="secFive_image3">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb50b9de34.jpg"
                                        alt="ছোট্ট চড়ুই-স্বর্ণের রিং যেভাবে মা এবং আমাকে কষ্ট দেয় "
                                        title="ছোট্ট চড়ুই-স্বর্ণের রিং যেভাবে মা এবং আমাকে কষ্ট দেয় ">
                            ...
                            <div class="secFive_moreNews">
                                <a href="news/category/feature.html"> আরো খবর </a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="section_three_bg">
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/traveling.html"> ভ্রমণ </a>
                            </h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_wrpp">
                                        <div class="secThree_image">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb8b468baf.jpg"
                                                alt="থাইল্যান্ড ভ্রমণে যে ভুল করলেই বিপদে পড়বেন"
                                                title="থাইল্যান্ড ভ্রমণে যে ভুল করলেই বিপদে পড়বেন">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb87a14c93.jpg"
                                                alt="বিশ্বের যে স্থানে রাত হয় না!" title="বিশ্বের যে স্থানে রাত হয় না!">
                                        </div><!-- End image-->
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb846ce54b.jpg"
                                                alt="মহাকাশে বেড়াতে যাবেন?" title="মহাকাশে বেড়াতে যাবেন?">
                                        </div><!-- End image-->
                                    ...
                                    <div class="secThree_item">
                                        ...
                                        <h4 class="secThree_title2">
                                            <a href="84.html"> সঙ্গীকে নিয়ে মালদ্বীপ ভ্রমণে যে ভুল করলেই বিপদে পড়বেন
                                            </a>
                                        </h4>
                                    </div><!--End item-->
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb7e00cc9c.jpg"
                                                alt="ঠান্ডায় যে শহরের মানুষের চোখের পাপড়ি-দাড়িও জমে যায় বরফে"
                                                title="ঠান্ডায় যে শহরের মানুষের চোখের পাপড়ি-দাড়িও জমে যায় বরফে">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="83.html"> ঠান্ডায় যে শহরের মানুষের চোখের পাপড়ি-দাড়িও জমে যায় বরফে
                                            </a>
                                        </h4>
                                    </div><!--End item-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <h4 class="more_news"><a href="news/category/traveling.html"> আরো খবর <i
                                                        class="la la-angle-double-right"></i> </a></h4>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_wrpp">
                                        <div class="secThree_image">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbb04ed0cc.jpg"
                                                alt="কক্সবাজারে বিদেশি ট্যুরিস্টদের জন্য আলাদা জোন হবে: কউক চেয়ারম্যান"
                                                title="কক্সবাজারে বিদেশি ট্যুরিস্টদের জন্য আলাদা জোন হবে: কউক চেয়ারম্যান">



                                        </div>
                                        <h4 class="secThree_title">
                                            <a href="92.html"> কক্সবাজারে বিদেশি ট্যুরিস্টদের জন্য আলাদা জোন হবে: কউক
                                                চেয়ারম্যান </a>
                                        </h4>
                                        <div class="content_details">
                                            এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbab557a38.jpg"
                                                alt="আবেদন ফি নিয়ে আন্দোলন করলে গুচ্ছ ছেড়ে দেব: জবি উপাচার্য "
                                                title="আবেদন ফি নিয়ে আন্দোলন করলে গুচ্ছ ছেড়ে দেব: জবি উপাচার্য ">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="91.html"> আবেদন ফি নিয়ে আন্দোলন করলে গুচ্ছ ছেড়ে দেব: জবি উপাচার্য 
                                            </a>
                                        </h4>
                                    </div><!--End item-->
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbba7540dd3.jpg"
                                                alt="যেভাবে অ্যামাজনে চাকরি পেলেন খুলনা বিশ্ববিদ্যালয়ের শিক্ষার্থী মনি"
                                                title="যেভাবে অ্যামাজনে চাকরি পেলেন খুলনা বিশ্ববিদ্যালয়ের শিক্ষার্থী মনি">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="90.html"> যেভাবে অ্যামাজনে চাকরি পেলেন খুলনা বিশ্ববিদ্যালয়ের
                                                শিক্ষার্থী মনি </a>
                                        </h4>
                                    </div><!--End item-->
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbba30b86a8.jpg"
                                                alt="খালেদা জিয়াকে আবার জেলে নেওয়া হলে আমরা রুখে দাঁড়াব: জবি ছাত্রদল সভাপতি"
                                                title="খালেদা জিয়াকে আবার জেলে নেওয়া হলে আমরা রুখে দাঁড়াব: জবি ছাত্রদল সভাপতি">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="89.html"> খালেদা জিয়াকে আবার জেলে নেওয়া হলে আমরা রুখে দাঁড়াব: জবি
                                                ছাত্রদল সভাপতি </a>
                                        </h4>
                                    </div><!--End item-->
                                    <div class="secThree_item">
                                        <div class="secThree_image2">
                                            <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                                data-src="https://themebazar.xyz/latestscript/public/postimages/63bbb9f348dc4.jpg"
                                                alt="অদিতির ‘অ-লক্ষুণে’ সামাজিক যোগাযোগ মাধ্যমে জনপ্রিয়তার শীর্ষে"
                                                title="অদিতির ‘অ-লক্ষুণে’ সামাজিক যোগাযোগ মাধ্যমে জনপ্রিয়তার শীর্ষে">
                                        </div><!-- End image-->


                                        <h4 class="secThree_title2">
                                            <a href="88.html"> অদিতির ‘অ-লক্ষুণে’ সামাজিক যোগাযোগ মাধ্যমে জনপ্রিয়তার
                                                শীর্ষে </a>
                                        </h4>
                                    </div><!--End item-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <h4 class="more_news"><a href="news/category/editorial.html"> আরো খবর <i
                                                        class="la la-angle-double-right"></i> </a></h4>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="secFour_wrpp">
                            ...
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/health.html"> স্বাস্থ্য </a>
                            </h2>
                            ...
                            <div class="secFour_image">
                                <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                    data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbc526482e.jpg"
                                    alt="জলবায়ুর পরিবর্তনের সঙ্গে সঙ্গে পরিবর্তন ঘটছে এডিস মশার ধরনেও"
                                    title="জলবায়ুর পরিবর্তনের সঙ্গে সঙ্গে পরিবর্তন ঘটছে এডিস মশার ধরনেও">
                            ...
                            <div class="content_details">
                                এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                ডেমো নিউজ।... <a href="#"></a> <a href="97.html"> বিস্তারিত</a>
                            </div>
                            ...
                            <div class="secFour_item">
                                <div class="secFour_image2">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbc11cd5d5.jpg"
                                        alt="তীব্র শীতে শিশু ও বয়স্কদের জন্য যে পরামর্শ দিলেন চিকিৎসক"
                                        title="তীব্র শীতে শিশু ও বয়স্কদের জন্য যে পরামর্শ দিলেন চিকিৎসক">
                            ...
                            <div class="secFour_item">
                                ...
                                <h4 class="secFour_title2">
                                    <a href="95.html"> চিকিৎসা সেবায় বাড়ছে বৈষম্য, গরিবদের চেয়ে ৮ গুণ বেশি খরচ করেন
                                        ধনীরা (ভিডিও) </a>
                                </h4>
                            </div><!--End item-->
                            <div class="secFour_item">
                                <div class="secFour_image2">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbbb0da336.jpg"
                                        alt="করোনায় মৃত্যুহীন দিনে শনাক্ত ১৭" title="করোনায় মৃত্যুহীন দিনে শনাক্ত ১৭">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/health.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="secFour_wrpp">
                            ...
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/court-of-law.html"> আইন আদালত </a>
                            </h2>
                            ...
                            <div class="secFour_image">
                                <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                    data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbd881f6a1.jpg"
                                    alt="ম্যুরালে বঙ্গবন্ধু ও প্রধানমন্ত্রীর সঙ্গে কারও ছবি নয়: হাইকোর্ট"
                                    title="ম্যুরালে বঙ্গবন্ধু ও প্রধানমন্ত্রীর সঙ্গে কারও ছবি নয়: হাইকোর্ট">
                            ...
                            <div class="content_details">
                                এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                ডেমো নিউজ।... <a href="#"></a> <a href="102.html"> বিস্তারিত</a>
                            </div>
                            ...
                            <div class="secFour_item">
                                <div class="secFour_image2">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbd4906458.jpg"
                                        alt="আপাতত হাতিরঝিলে কোনো উচ্ছেদ নয়: আপিল বিভাগ (ভিডিও)"
                                        title="আপাতত হাতিরঝিলে কোনো উচ্ছেদ নয়: আপিল বিভাগ (ভিডিও)">
                            ...
                            <div class="secFour_item">
                                ...
                                <h4 class="secFour_title2">
                                    <a href="100.html"> ওয়াসার এমডির ১৪ বাড়ি: দুদকের অগ্রগতি জানতে চাইলেন হাইকোর্ট
                                        (ভিডিও) </a>
                                </h4>
                            </div><!--End item-->
                            <div class="secFour_item">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/court-of-law.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="secFour_wrpp">
                            ...
                            <h2 class="themesBazar_cat01">
                                <a href="news/category/opinion.html"> মতামত </a>
                            </h2>
                            ...
                            <div class="content_details">
                                এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা ডেমো নিউজ। এটা একটা
                                ডেমো নিউজ।... <a href="#"></a> <a href="107.html"> বিস্তারিত</a>
                            </div>
                            ...
                            <div class="secFour_item">
                                <div class="secFour_image2">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbe6875836.jpg"
                                        alt="ইন্টারনেট: ব্যবহার, অপব্যবহার, অতিব্যবহার ও আসক্তি"
                                        title="ইন্টারনেট: ব্যবহার, অপব্যবহার, অতিব্যবহার ও আসক্তি">
                            ...
                            <div class="secFour_item">
                                <div class="secFour_image2">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbe35642fe.jpg"
                                        alt="বিজয়ের পুরো অর্থ আমাদের বুঝতে হবে" title="বিজয়ের পুরো অর্থ আমাদের বুঝতে হবে">
                            ...
                            <div class="secFour_item">
                                <div class="secFour_image2">
                                    <img class="lazyload" src="public/templateimage/63c40b42843c8.jpg"
                                        data-src="https://themebazar.xyz/latestscript/public/postimages/63bbbe07b798a.jpg"
                                        alt="রোহিঙ্গা ঝুঁকিতে পর্যটন শিল্প নগরী কক্সবাজার"
                                        title="রোহিঙ্গা ঝুঁকিতে পর্যটন শিল্প নগরী কক্সবাজার">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/opinion.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
        ...
        <section class="photoGallery">
            <div class="container">
                <div class="row">
                        ...
                        <div class="themesBazar_gallery">
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab12bda32d.jpg"
                                        title="পাহাড়পুর বৌদ্ধ বিহার, রাজশাহী">
                                        <img src="public/gallery/63bab12bda32d.jpg" alt="পাহাড়পুর বৌদ্ধ বিহার, রাজশাহী" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab11ea2d3a.jpg"
                                        title="সিলেটের মাধবকুণ্ড জলপ্রপাত, এখনও পর্যটকদের কাছে আকর্ষণীয়।">
                                        <img src="public/gallery/63bab11ea2d3a.jpg"
                                            alt="সিলেটের মাধবকুণ্ড জলপ্রপাত, এখনও পর্যটকদের কাছে আকর্ষণীয়।" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab10341522.jpg"
                                        title="মহেরা জমিদার বাড়ি টাঙ্গাইল">
                                        <img src="public/gallery/63bab10341522.jpg" alt="মহেরা জমিদার বাড়ি টাঙ্গাইল" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab0f744589.jpg"
                                        title="দর্শনীয় স্থান: মাধবপুর লেক">
                                        <img src="public/gallery/63bab0f744589.jpg" alt="দর্শনীয় স্থান: মাধবপুর লেক" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab0eab6cfd.jpg"
                                        title="বঙ্গবন্ধু শেখ মুজিব সাফারি পার্ক বা সংক্ষেপে বঙ্গবন্ধু সাফারি পার্ক বাংলাদেশের গাজীপুর জেলার শ্রীপুর উপজেলাধীন অবস্থিত">
                                        <img src="public/gallery/63bab0eab6cfd.jpg"
                                            alt="বঙ্গবন্ধু শেখ মুজিব সাফারি পার্ক বা সংক্ষেপে বঙ্গবন্ধু সাফারি পার্ক বাংলাদেশের গাজীপুর জেলার শ্রীপুর উপজেলাধীন অবস্থিত" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab0dcc6177.jpg"
                                        title="নিঝুম দ্বীপ: নিঝুম দ্বীপ বাংলাদেশের একটি ছোট্ট দ্বীপ। এটি নোয়াখালী জেলার হাতিয়া উপজেলার অন্তর্গত।">
                                        <img src="public/gallery/63bab0dcc6177.jpg"
                                            alt="নিঝুম দ্বীপ: নিঝুম দ্বীপ বাংলাদেশের একটি ছোট্ট দ্বীপ। এটি নোয়াখালী জেলার হাতিয়া উপজেলার অন্তর্গত।" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab0d30ec81.jpg"
                                        title="সাজেক ভ্যালি বা সাজেক উপত্যকা বাংলাদেশের রাঙ্গামাটি জেলার বাঘাই উপজেলার সাজেক ইউনিয়নের একটি বিখ্যাত পর্যটন স্থল">
                                        <img src="public/gallery/63bab0d30ec81.jpg"
                                            alt="সাজেক ভ্যালি বা সাজেক উপত্যকা বাংলাদেশের রাঙ্গামাটি জেলার বাঘাই উপজেলার সাজেক ইউনিয়নের একটি বিখ্যাত পর্যটন স্থল" />
                                    </a>
                                </figure>
                            ...
                            <div class="gallery_wrpp">
                                <figure class="gallery_image">
                                    <a class="themeGallery" href="public/gallery/63bab0c44a4dd.jpg"
                                        title="সেন্টমার্টিন: সেন্টমার্টিন বাংলাদেশের একমাত্র প্রবাল দ্বীপ যা দেশের মূলভূখণ্ডের সর্ব দক্ষিণের একটি ক্ষুদ্র দ্বীপ।">
                                        <img src="public/gallery/63bab0c44a4dd.jpg"
                                            alt="সেন্টমার্টিন: সেন্টমার্টিন বাংলাদেশের একমাত্র প্রবাল দ্বীপ যা দেশের মূলভূখণ্ডের সর্ব দক্ষিণের একটি ক্ষুদ্র দ্বীপ।" />
                                    </a>
                                </figure>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <h2 class="themesBazar_cat01">
                            <a href="news/category/press-release.html"> প্রেস বিজ্ঞপ্তি </a>
                        </h2>
                        ...
                        <div class="secEight_wrpp">
                            ...
                            <div class="secEight_item">
                                ...
                                <h4 class="secEight_title">
                                    <a href="132.html"> রিহ্যাব ফেয়ারে পদ্মা ব্যাংকের বিশেষ গৃহঋণ সেবা </a>
                                </h4>
                            </div><!--End Itme-->
                            ...
                            <div class="secEight_item">
                                ...
                                <h4 class="secEight_title">
                                    <a href="131.html"> সিলেট স্ট্রাইকার্সের সাথে এক্স-সিরামিকস </a>
                                </h4>
                            </div><!--End Itme-->
                            ...
                            <div class="secEight_item">
                                ...
                                <h4 class="secEight_title">
                                    <a href="130.html"> দেশব্যাপী পালিত হলো টোটাল ফিটনেস ডে </a>
                                </h4>
                            </div><!--End Itme-->
                            ...
                            <div class="secEight_item">
                                ...
                                <h4 class="secEight_title">
                                    <a href="129.html"> সৃষ্টিশীল কাজে পৃষ্ঠপোষকতা বাড়াতে হবে: সমাজকল্যাণমন্ত্রী </a>
                                </h4>
                            </div><!--End Itme-->
                            ...
                            <div class="secEight_item">
                                ...
                                <h4 class="secEight_title">
                                    <a href="128.html"> ওটিএ ও আইসিএ অ্যাসোসিয়েশনের কেন্দ্রীয় কার্যনির্বাহী পরিষদের নতুন
                                        কমিটি ঘোষণা </a>
                                </h4>
                            </div><!--End Itme-->
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h4 class="more_news"><a href="news/category/press-release.html"> আরো খবর <i
                                                class="la la-angle-double-right"></i> </a></h4>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            $("select[name='divi_id']").on('change', function () {
                ...
                if (divi_id) {
                    $.ajax({
                        url: "{{url('/get/distr/')}}/" + divi_id, // Ensure this URL is correct
                        type: "GET",
                        dataType: "json",
                        success: function (data) {
                            $("#dist_id").empty();
